...
export default function loopExtension(pi: ExtensionAPI): void {
	...
	pi.registerTool({
		...
		promptSnippet: "Stop the active loop when the breakout condition is satisfied. Only call this tool when explicitly instructed to do so by the user, tool or system prompt.",
